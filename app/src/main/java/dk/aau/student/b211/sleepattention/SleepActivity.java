    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        startSleep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int sleepOffset = Integer.parseInt(
                        sharedPreferences.getString(
                                getString(R.string.preferences_time_to_sleep_key), "15"));
                Log.d(TAG, "SleepOffset is: " + sleepOffset);
                SharedPreferences.Editor preferencesEditor = sharedPreferences.edit();
                currentTime.add(Calendar.MINUTE, sleepOffset);
                preferencesEditor.putLong(getString(R.string.misc_sleep_time_key),
                        currentTime.getTimeInMillis());
                preferencesEditor.putLong(getString(R.string.misc_alarm_time_key),
                        alarmTime.getTimeInMillis());
                isAlarmOn = true;
                preferencesEditor.putBoolean(getString(R.string.misc_is_alarm_on_key),
                        isAlarmOn);
                ...
                packageManager.setComponentEnabledSetting(receiver, PackageManager
                ...
                pendingintent = PendingIntent.getBroadcast(SleepActivity.this,
                        0,
                        alarmReceiverIntent,
                ...
                long millis = alarmTime.getTimeInMillis() - Calendar.getInstance()
                        .getTimeInMillis();
        ...
        endSleep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentTime = Calendar.getInstance();
                long duration = currentTime.getTimeInMillis() - sharedPreferences
                        .getLong(getString(R.string.misc_sleep_time_key), 0);
                if (duration > 0) {
                    //Save to database.
                    new SleepRepository(SleepActivity.this)
                            .insertRecord(duration, currentTime.getTime(), 0);
                    //Show a message to user stating time slept.
                    String message = String.format(
                            getString(R.string.sleep_log_stop),
                    ...
                    Toast.makeText(SleepActivity.this, getString(R.string.sleep_negative_sleep),
